...
Estado integrado: posição em kpc, velocidade em kpc/Gyr, tempo em Gyr. Interface: km/s; potenciais e energias específicas em (km/s)²; Lz específico em kpc km/s. Uma unidade gráfica de posição equivale a um kpc, mas tamanho, brilho e halo luminoso dos marcadores são exagerados. As estrelas decorativas não têm massa na integração.
