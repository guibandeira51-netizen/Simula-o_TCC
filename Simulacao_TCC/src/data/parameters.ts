...
export const REFERENCES = {
  ...
  schodel: {
    title: "Schödel et al. (2014), núcleo estelar da Via Láctea",
    url: "https://arxiv.org/abs/1403.6657",
...
export const PHYSICAL_PARAMETERS: Readonly<Record<string, PhysicalParameter>> = {
  ...
  nucleusMass: { value: 1.71e9, unit: "M☉", symbol: "M_n", description: "Massa do núcleo Hernquist", source: "gala" },
  nucleusScaleRadius: { value: 0.07, unit: "kpc", symbol: "a_n", description: "Escala do núcleo Hernquist", source: "gala" },
...
export const MODEL = Object.freeze({
  ...
  // Componente nuclear compacta independente do bojo no ajuste publicado Gala v1.
  // Mantida apenas como parte desse benchmark; não é uma massa adicional inventada.
  nucleus: Object.freeze({
    mass: PHYSICAL_PARAMETERS.nucleusMass.value,
    a: PHYSICAL_PARAMETERS.nucleusScaleRadius.value,
  }),
  halo: Object.freeze({
...
export const PARAMETER_ROWS: [
  ...
  ["Núcleo: massa estelar", PHYSICAL_PARAMETERS.nucleusMass.symbol, PHYSICAL_PARAMETERS.nucleusMass.value, PHYSICAL_PARAMETERS.nucleusMass.unit, PHYSICAL_PARAMETERS.nucleusMass.source],
  ["Núcleo: escala", PHYSICAL_PARAMETERS.nucleusScaleRadius.symbol, PHYSICAL_PARAMETERS.nucleusScaleRadius.value, PHYSICAL_PARAMETERS.nucleusScaleRadius.unit, PHYSICAL_PARAMETERS.nucleusScaleRadius.source],
  [
